...
function FaqOption(props: FaqOptionProps) {
    ...
    return (
        <Box sx={{ width: "85vw", maxWidth: "1000px", margin: "auto", p: 2, borderRadius: ".7rem", backgroundColor: "#F6F6F6" }}>
        ...
        <section id="faq">
            <Container sx={{ pb: "5rem" }}>
                ...
                <Box sx={{ display: "flex", flexDirection: "column", gap: ".5rem" }}>
                    ...
                    <FaqOption pergunta={"O que acontece se eu não atualizar meus dados?"} resposta={"Se você não atualizar seus dados, poderá enfrentar dificuldades no acesso ao condomínio e na utilização de serviços oferecidos."} Expandir={Expandir} />
                    ...
                    <FaqOption pergunta={"E se eu tiver alguma dúvida?"} resposta={'Em caso de dúvidas, entre em contato conosco ao clicar no botão "Contate-nos" no topo da página.'} Expandir={Expandir} />
                </Box>
            </Container>
        </section>
    );
