...
export const Footer = () => {
    return (
        <Container sx={{ p: "4rem", display: "flex", backgroundColor: "secondary.main", color: "white", justifyContent: "space-evenly", flexDirection: {xs:"row", sm:"column", md:"row", lg:"row"}, gap: "2rem", alignItems: "center", maxWidth: { lg: "100vw" } }}>
